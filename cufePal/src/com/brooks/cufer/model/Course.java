...
public class Course extends DataSupport
{
	...
	public String toString()
	{
		return "Course [id=" + id + ", startYear=" + startYear + ", endYear="
				+ endYear + ", semester=" + semester + ", courseType="
				+ courseType + ", courseName=" + courseName + ", courseTime="
				+ courseTime + ", classsroom=" + classsroom + ", teacher="
				+ teacher + ", dayOfWeek=" + dayOfWeek + ", startSection="
				+ startSection + ", endSection=" + endSection + ", startWeek="
				+ startWeek + ", endWeek=" + endWeek + ", everyWeek="
				+ everyWeek + "]";
	}
}
